import numpy as np  # Standart kısaltmadır, herkes 'np' olarak kullanır.
...
# İşte mühendislik büyüsü burada:
...
# 4. LINSPACE (Linear Space - ÇOK ÖNEMLİ!)
# Elektrik Müh. için en önemlisi! 
